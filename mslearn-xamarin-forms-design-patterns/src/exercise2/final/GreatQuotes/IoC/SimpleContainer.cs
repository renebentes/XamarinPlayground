...
namespace GreatQuotes.IoC
{
    ...
    {
        private readonly Dictionary<Type, Func<object>> registeredCreators = new Dictionary<Type, Func<object>>();
        ...
        public object Create(Type type)
        {
            ...
            if (registeredCreators.TryGetValue(type, out Func<object> creator))
